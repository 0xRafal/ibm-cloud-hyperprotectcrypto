...
import (
	context "context"
	fmt "fmt"
	github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11 "github.com/0xRafal/ibm-cloud-hyperprotectcrypto/golang/ep11"
...
type GenerateKeyRequest struct {
	Mech                 *Mechanism                                                                       `protobuf:"bytes,1,opt,name=Mech,proto3" json:"Mech,omitempty"`
	Template             map[github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Attribute][]byte `protobuf:"bytes,2,rep,name=Template,proto3,castkey=github.com/0xRafal/ibm-cloud-hyperprotectcrypto/golang/ep11.Attribute" json:"Template,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (m *GenerateKeyRequest) GetTemplate() map[github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Attribute][]byte {
	if m != nil {
		return m.Template
	}
	return nil
...
type GenerateKeyPairRequest struct {
	Mech                 *Mechanism                                                                       `protobuf:"bytes,1,opt,name=Mech,proto3" json:"Mech,omitempty"`
	PubKeyTemplate       map[github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Attribute][]byte `protobuf:"bytes,2,rep,name=PubKeyTemplate,proto3,castkey=github.com/0xRafal/ibm-cloud-hyperprotectcrypto/golang/ep11.Attribute" json:"PubKeyTemplate,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	PrivKeyTemplate      map[github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Attribute][]byte `protobuf:"bytes,3,rep,name=PrivKeyTemplate,proto3,castkey=github.com/0xRafal/ibm-cloud-hyperprotectcrypto/golang/ep11.Attribute" json:"PrivKeyTemplate,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (m *GenerateKeyPairRequest) GetPubKeyTemplate() map[github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Attribute][]byte {
	if m != nil {
...
func (m *GenerateKeyPairRequest) GetPrivKeyTemplate() map[github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Attribute][]byte {
	if m != nil {
...
type UnwrapKeyRequest struct {
	...
	Template             map[github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Attribute][]byte `protobuf:"bytes,6,rep,name=Template,proto3,castkey=github.com/0xRafal/ibm-cloud-hyperprotectcrypto/golang/ep11.Attribute" json:"Template,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (m *UnwrapKeyRequest) GetTemplate() map[github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Attribute][]byte {
	if m != nil {
		return m.Template
	}
	return nil
...
func (m *DeriveKeyRequest) GetTemplate() map[github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Attribute][]byte {
	if m != nil {
		return m.Template
	}
	return nil
...
type GetMechanismListResponse struct {
	Mechs                []github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Mechanism `protobuf:"varint,2,rep,packed,name=Mechs,proto3,casttype=github.com/0xRafal/ibm-cloud-hyperprotectcrypto/golang/ep11.Mechanism" json:"Mechs,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                                                                `json:"-"`
	XXX_unrecognized     []byte                                                                  `json:"-"`
	XXX_sizecache        int32                                                                   `json:"-"`
}
...
func (m *GetMechanismListResponse) GetMechs() []github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Mechanism {
	if m != nil {
		return m.Mechs
	}
	return nil
...
type GetMechanismInfoRequest struct {
	Mech                 github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Mechanism `protobuf:"varint,2,opt,name=Mech,proto3,casttype=github.com/0xRafal/ibm-cloud-hyperprotectcrypto/golang/ep11.Mechanism" json:"Mech,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                                                              `json:"-"`
	XXX_unrecognized     []byte                                                                `json:"-"`
	XXX_sizecache        int32                                                                 `json:"-"`
}
...
func (m *GetMechanismInfoRequest) GetMech() github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Mechanism {
	if m != nil {
		return m.Mech
	}
	return 0
...
type GetAttributeValueRequest struct {
	...
	Attributes           map[github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Attribute][]byte `protobuf:"bytes,2,rep,name=Attributes,proto3,castkey=github.com/0xRafal/ibm-cloud-hyperprotectcrypto/golang/ep11.Attribute" json:"Attributes,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}                                                                         `json:"-"`
	XXX_unrecognized     []byte                                                                           `json:"-"`
	XXX_sizecache        int32                                                                            `json:"-"`
}
...
func (m *GetAttributeValueRequest) GetAttributes() map[github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Attribute][]byte {
	if m != nil {
		return m.Attributes
	}
	return nil
...
func (m *GetAttributeValueResponse) GetAttributes() map[github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Attribute][]byte {
	if m != nil {
		return m.Attributes
	}
	return nil
...
func (m *SetAttributeValueRequest) GetAttributes() map[github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Attribute][]byte {
	if m != nil {
		return m.Attributes
	}
	return nil
...
type Mechanism struct {
	Mechanism            github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Mechanism `protobuf:"varint,1,opt,name=Mechanism,proto3,casttype=github.com/0xRafal/ibm-cloud-hyperprotectcrypto/golang/ep11.Mechanism" json:"Mechanism,omitempty"`
...
func (m *Mechanism) GetMechanism() github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Mechanism {
	if m != nil {
		return m.Mechanism
	}
	return 0
...
type Grep11Error struct {
	Code                 github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Return `protobuf:"varint,1,opt,name=Code,proto3,casttype=github.com/0xRafal/ibm-cloud-hyperprotectcrypto/golang/ep11.Return" json:"Code,omitempty"`
...
func (m *Grep11Error) GetCode() github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Return {
	if m != nil {
		return m.Code
	}
	return 0
...
func init() {
	...
	proto.RegisterMapType((map[github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Attribute][]byte)(nil), "grep11.GenerateKeyRequest.TemplateEntry")
	...
	proto.RegisterMapType((map[github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Attribute][]byte)(nil), "grep11.GenerateKeyPairRequest.PrivKeyTemplateEntry")
	proto.RegisterMapType((map[github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Attribute][]byte)(nil), "grep11.GenerateKeyPairRequest.PubKeyTemplateEntry")
	...
	proto.RegisterMapType((map[github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Attribute][]byte)(nil), "grep11.UnwrapKeyRequest.TemplateEntry")
	...
	proto.RegisterMapType((map[github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Attribute][]byte)(nil), "grep11.DeriveKeyRequest.TemplateEntry")
	...
	proto.RegisterMapType((map[github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Attribute][]byte)(nil), "grep11.GetAttributeValueRequest.AttributesEntry")
	proto.RegisterType((*GetAttributeValueResponse)(nil), "grep11.GetAttributeValueResponse")
	proto.RegisterMapType((map[github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Attribute][]byte)(nil), "grep11.GetAttributeValueResponse.AttributesEntry")
	proto.RegisterType((*SetAttributeValueRequest)(nil), "grep11.SetAttributeValueRequest")
	proto.RegisterMapType((map[github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Attribute][]byte)(nil), "grep11.SetAttributeValueRequest.AttributesEntry")
...
var fileDescriptor_ad098daeda4239f7 = []byte{
	...
	,
}
...
func (m *GenerateKeyRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.Template == nil {
				m.Template = make(map[github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Attribute][]byte)
			}
			var mapkey uint64
			mapvalue := []byte{}
			for iNdEx < postIndex {
			...
			m.Template[github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Attribute(mapkey)] = mapvalue
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.PubKeyTemplate == nil {
				m.PubKeyTemplate = make(map[github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Attribute][]byte)
			}
			var mapkey uint64
			mapvalue := []byte{}
			for iNdEx < postIndex {
			...
			m.PubKeyTemplate[github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Attribute(mapkey)] = mapvalue
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
			...
			if m.PrivKeyTemplate == nil {
				m.PrivKeyTemplate = make(map[github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Attribute][]byte)
			}
			var mapkey uint64
			mapvalue := []byte{}
			for iNdEx < postIndex {
			...
			m.PrivKeyTemplate[github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Attribute(mapkey)] = mapvalue
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
...
func (m *GetMechanismListResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType == 0 {
				var v github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Mechanism
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
						return ErrIntOverflowServer
					}
					...
					b := dAtA[iNdEx]
					iNdEx++
					v |= github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Mechanism(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
				...
				if elementCount != 0 && len(m.Mechs) == 0 {
					m.Mechs = make([]github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Mechanism, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Mechanism
					for shift := uint(0); ; shift += 7 {
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Mech |= github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Mechanism(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *GetAttributeValueRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.Attributes == nil {
				m.Attributes = make(map[github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Attribute][]byte)
			}
			var mapkey uint64
			mapvalue := []byte{}
			for iNdEx < postIndex {
			...
			m.Attributes[github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Attribute(mapkey)] = mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipServer(dAtA[iNdEx:])
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Mechanism |= github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Mechanism(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Code |= github_com_0xRafal_ibm_cloud_hyperprotectcrypto_golang_ep11.Return(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
